...
function buildRecommendations(
  ...
  if (standing === 'capacity_exhausted') {
    recs.push('Contact Soberanía to expand organization registry passport capacity.');
  }
...
export function buildRegistryGovernanceReportMarkdown(
  ...
  const lines: string[] = [
    '# Soberanía Agent Registry Governance Report',
    '',
    '---',
    '',
    '## Registry Summary',
  ...
  lines.push(
    ...
    '---',
    '',
    '*This report was generated by Soberanía Agent Passport. It is provided as governance evidence for internal use only.*',
    '',
  );
...
<title>Soberanía Agent Registry Governance Report</title>
<style>

...
export const POLICY_PACK_PAYMENT_APPROVAL_REQUIRED_SCENARIO: DemoScenario = {
  ...
  enterpriseMessage: 'Soberanía can prevent autonomous financial execution unless the enterprise policy pack requires and receives finance approval.',
  ...
  aocValue:
    'The payments-basic policy pack is evaluated by Action Enforcement during preflight; it requires a finance_review approval before approve_payment may proceed, and enforcement blocks execution until that approval exists -- exactly like every other Soberanía governance layer.',
  ...
  steps: [
    ...
    },
    {
      ...
      description: 'Summarize that Soberanía blocks financial execution until finance review exists, per the payments-basic demo policy pack.',

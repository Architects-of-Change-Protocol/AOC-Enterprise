...
/**
 * The Runtime Host's one composition root for the transitive engines a
 ...
 * as separate Kernel-level ports. This module is where the Runtime
 ...
 * Runtime-Host-specific shortcut. Seeding real governance data is a
 * deployment/operations concern, not something this Runtime Host may

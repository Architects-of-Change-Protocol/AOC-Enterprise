 ...
 * Every Runtime Host test that needs an "allowed" or "approval_required"
 * outcome uses this instead of the Runtime's own fail-closed empty default
...
/** The canonical "everything checks out" allowed scenario, as a Runtime Host wire request body. */

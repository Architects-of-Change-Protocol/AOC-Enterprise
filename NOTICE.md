...
- `docs/legal/OPEN_SOURCE_DEPENDENCIES.md` — inventory of direct
  dependencies, their licenses, and usage.
- `docs/legal/THIRD_PARTY_NOTICES.md` — required or reasonably necessary
  third-party notices.

## Capabilities described in this repository

This NOTICE does not itself describe or warrant specific product
capabilities. For an accurate, evidence-based inventory of what is
implemented, in progress, or a placeholder within this repository, see
`docs/legal/IP_OVERVIEW.md`, Section 2 ("Core proprietary assets").
Stubs, placeholders, and roadmap items are explicitly excluded from that
inventory's "implemented" classification.

## Further reading

- `LICENSE` — the governing proprietary license.
- `COPYRIGHT.md` — scope and exclusions of the copyright claim.
- `TRADEMARKS.md` — trademark and intended-trademark notices.
- `CONTRIBUTING.md` — contribution and IP-provenance requirements.
- `SECURITY.md` — vulnerability disclosure policy.
- `docs/legal/PROTOCOL_ENTERPRISE_BOUNDARY.md` — Protocol/Enterprise
  boundary.

...
exports.generateAgentPassportId = generateAgentPassportId;
exports.isValidAgentPassportId = isValidAgentPassportId;
const crypto_1 = require("crypto");
const CHARS = 'ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789';
const PASSPORT_ID_REGEX = /^AOC-AGT-\d{4}-[A-Z0-9]{1,12}-[A-Z0-9]{6}$/;
function generateEntropy(length) {
    const bytes = (0, crypto_1.randomBytes)(length * 4);
    let result = '';
...
function generateAgentPassportId(options) {
...
function isValidAgentPassportId(value) {

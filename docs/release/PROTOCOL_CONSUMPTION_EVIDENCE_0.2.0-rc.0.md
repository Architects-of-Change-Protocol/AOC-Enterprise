...
| `npm run validate:v1-release` | FAIL | 1 | **Pre-existing**: `release/RELEASE_MANIFEST.json` is stale. Reproduced identically on untouched `origin/main` — not caused by this increment |

// Generates release/RELEASE_MANIFEST.json for the current build (PR-008).
//
// Run AFTER `npm run build`:
//   node scripts/generate-release-manifest.mjs
//
// The manifest is reproducible for a given commit + build output: it records
// versions, schema identifiers, and SHA-256 checksums of the public build
// artifacts so a release can be independently re-verified.
...
console.log(`version=${manifest.version} commit=${manifest.generated.commit} artifacts=${artifacts.length}`);

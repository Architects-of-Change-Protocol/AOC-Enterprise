/**
 * Type-only stand-in for @aoc/protocol, mirroring the structural surface the
 * Enterprise repository compiles against (see types/aoc-protocol/index.d.ts).
 * Used only by release tooling; never shipped.
 */
